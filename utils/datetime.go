...
//时间戳转年月日
func DateFormatYm(timestamp int64) string {
	tm := time.Unix(timestamp, 0)
	return tm.Format("2006-01")
}

//时间戳转年月日
func DateFormatYmd(timestamp int64) string {
	tm := time.Unix(timestamp, 0)
	return tm.Format("2006-01-02")
}

// 时间戳转年月日 时分
func DateFormatYmdhm(timestamp int64) string {
	tm := time.Unix(timestamp, 0)
	return tm.Format("2006-01-02 15:04")
}

// 时间戳转年月日 时分秒
func DateFormatYmdhms(timestamp int64) string {
	tm := time.Unix(timestamp, 0)
